...
function setup() {
  ...
  imgast = loadImage("meteorite.png")
  imglaser = loadImage("laser.png")
  imgspeed = loadImage("speedup.png")
  imgship = loadAnimation('spaceship2.png',"spaceship3.png");
  console.log(imgship)
...
function gethighscore(){
  return parseInt(document.cookie.replace(/(.*\; )/, ""));
}
